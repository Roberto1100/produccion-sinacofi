...
def validate_not_deleted(connector: Connection, t_doc, correlativo, file):
    ...
    if result is not None:
        reject_and_save_error(connector, correlativo, '087', f"Tipo de documento está eliminado: {t_doc}", file)
